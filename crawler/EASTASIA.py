...
fileName = ['HSI','KS11','N225','SHI']  #香港 韓國 日本 上海
...
try:
    for i in fileName:
        ...
        #網址
        fileNameDic = {'HSI':'%5EHSI','KS11':'%5EKS11','N225':'%5EN225','SHI':'000001.SS'}

        url = 'https://finance.yahoo.com/quote/{}/history?p={}'.format(fileNameDic[i],fileNameDic[i])
...
#擷取失敗原因
    ...
    log = '{}-{}:執行失敗({})\n'.format(timeStamp, 'EASTASIA', errMsg)
